...
class Encoder_Decoder(nn.Module):
    ...
    def forward(self, secret, cover):
        ...
        # 在hiding之前，把cover与hiding合在一起
        mid = torch.cat((x_1, cover), 1)
        x_2, x_2_noise = self.hiding(mid)
        # Add Noise
        noise_layer = Cropout((0.55, 0.6), (0.55, 0.6))
        x_2_attacked, cropout_label = noise_layer(x_2, cover)

        x_3 = self.extract(x_2_attacked)
        return x_2, x_3, cropout_label